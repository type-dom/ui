...
export const buildLocaleContext = (
  ...
  const localeRef = isRef(locale) ? locale : signal(locale);
  return {
    lang,
    locale: localeRef,
...
export const useLocale = (localeOverrides?: Ref<Language | undefined>) => {
  const locale = localeOverrides || inject(localeContextKey, signal())!;
  return buildLocaleContext(computed(() => locale.get() || English));
};
