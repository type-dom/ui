...
// import { AnyFn, nextTick } from '@type-dom/framework';
// import { computed, signal, unref, watch } from '@type-dom/signals';
// import { castArray, isArray } from '@type-dom/utils';
...
// };
//
// export const useBasicDateTable = (props: BasicDateTableProps, emit: AnyFn) => {
//   const { lang } = useLocale();
//   const tbodyRef = signal<HTMLElement>();
//   const currentCellRef = signal<HTMLElement>();
//   // data
//   const lastRow = signal<number>();
//   const lastColumn = signal<number>();
//   const tableRows = signal<DateCell[][]>([[], [], [], [], [], []]);
//
//   let focusWithClick = false;
//
//   // todo better way to get Day.js locale object
//   const firstDayOfWeek = (props.date as any).$locale().weekStart || 7;
//   const WEEKS_CONSTANT = props
//     .date!.locale('en')
//     // .localeData() // todo
//     // .weekdaysShort()
//     // .map((_) => _.toLowerCase());
