...
// // import { mount } from '@vue/test-dts-utils'
// import { afterEach, describe, expect, test-dts, vi } from 'vitest'
// // import { debugWarn } from '@element-plus/utils'
// // import { Checked, CircleClose, Hide, View } from '@element-plus/icons-vue'
// // import { ElFormItem } from '@element-plus/components/form'
// // import { UPDATE_MODEL_EVENT } from '@element-plus/constants'
// // import Switch from '../src/switch.vue'
// // import type { VueWrapper } from '@vue/test-dts-utils'
...
//       width: 100,
//     }
//     const wrapper = mount(() => <TdSwitch {...props} />)
//     const vm = wrapper.vm
...
//   })
//
//   test-dts('value correctly update', async () => {
...
//   })
//
//   test-dts('disabled switch should not respond to user click', async () => {
//     const value = ref(true)
...
//   })
//
//   test-dts('expand switch value', async () => {
//     const value = ref('100')
...
//   })
//
//   test-dts('default switch active-value is false', async () => {
...
//   })
//
//   test-dts('value is the single source of truth', async () => {
...
//   })
//
//   test-dts('model-value is the single source of truth', async () => {
...
//   })
//
//   test-dts('sets checkbox value', async () => {
//     const value = ref(false)
//     const wrapper = mount(() => (
//       <div>
...
//   })
//
//   test-dts('beforeChange function return promise', async () => {
//     const value = ref(true)
...
//   })
//
//   test-dts('beforeChange function return boolean', async () => {
//     const value = ref(true)
...
//   })
//
//   test-dts('custom action icon', async () => {
//     const value = ref(true)
//     const wrapper = mount(() => (
//       <div>
//         <Switch
...
//     test-dts('automatic id attachment', async () => {
//       const wrapper = mount(() => (
//         <ElFormItem label="Foobar" data-test-dts-ref="item">
//           <Switch />
//         </ElFormItem>
//       ))
//
//       await nextTick()
//       const formItem = wrapper.find('[data-test-dts-ref="item"]')
...
//     })
//
//     test-dts('specified id attachment', async () => {
//       const wrapper = mount(() => (
//         <ElFormItem label="Foobar" data-test-dts-ref="item">
//           <Switch id="foobar" />
//         </ElFormItem>
...
//     })
//
//     test-dts('form item role is group when multiple inputs', async () => {
//       const wrapper = mount(() => (
//         <ElFormItem label="Foobar" data-test-dts-ref="item">
//           <Switch />
//           <Switch />
...
//     })
//
//     test-dts('custom switch action slots', async () => {
//       const value = ref(true)
//       const wrapper = mount({
//         setup: () => () =>
//           (
