...
export type { OptionGroupProps } from './td-option-group/td-option-group.interface';

export { TdRadio } from './td-radio/td-radio.class';
export type * from './td-radio/td-radio.interface';
export { TdRadioButton } from './td-radio-button/td-radio-button.class';
export type * from './td-radio-button/td-radio-button.interface';
export { TdRadioGroup } from './td-radio-group/td-radio-group.class';
export type * from './td-radio-group/td-radio-group.interface';
export { TdRate } from './td-rate/td-rate.class';
export type * from './td-rate/td-rate.interface';

export { TdSelect } from './td-select/td-select.class';
export type * from './td-select/td-select.interface';
export { TdSlider } from './td-slider/td-slider.class';
