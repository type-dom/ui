...
import {
  $borderColors, $borderRadiusMap,
  $borderStyle,
  $borderWidth,
  $buttonBgColor,
  $colors, $colorWhite,
  $commonComponentSize, $fillColors, $fontSizes,
  $fontWeightPrimary, $paddingHorizontalMap, $paddingVerticalMap, $textColors
} from '../../styles/var';
