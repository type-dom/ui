import { $borderColors, $colors, $textColors, $transitionDuration, $transitionDurationFast } from '../../styles/var';
...
export const $switchOffColor = $borderColors.base;
// --el-switch-off-color: var(--el-border-color);
export const $switchBorderColor = $borderColors.base;
