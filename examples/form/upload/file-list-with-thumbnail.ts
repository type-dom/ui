...
export class UploadFileListWithThumbnailExample extends TypeDiv {
  className = 'UploadFileListWithThumbnailExample';
 ...
 override  setup() {
    ...
    this.addChildren(
      new TdUpload({
        ...
        emits: {
          'update-first-file-list': (_uploadFiles: UploadUserFile[]) => {
            // todo
          }
        },
        slots: {
